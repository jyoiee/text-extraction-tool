    ...
    <body>
                            ...
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content" style="backface-visibility: visible">
                                    <div class="modal-header" style="background-color: #e8e8e8">
                                        ...
                                        <h4 class="modal-title" style="color: #613d7c">Meaning of the selected word : <span id="searched-word"></span></h4>
                                    </div>
        ...
        <script>
            $('document').ready(function () {
                $(".tt").mouseup(function (e) {
                   // var text = getSelectedText();
                    var text =  get_selection(e);
//                    if (text != '')
//                    {
//                       
//                    }
